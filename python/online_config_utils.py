...
def normalize_online_config_payload(payload: Mapping[str, Any], *, repo_root: str | Path) -> dict[str, Any]:
    ...
    controller_cfg.setdefault("singularity_tracking_task_slack_weight", 2.0e3)
    controller_cfg.setdefault("singularity_arm_posture_weight", 1.50)
    controller_cfg.setdefault("singularity_add_arm_posture_task", True)
    controller_cfg.setdefault("singularity_arm_posture_task_slack_weight", 2.0e4)
    controller_cfg.setdefault("singularity_add_platform_preference_task", True)
